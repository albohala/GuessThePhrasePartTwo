//
//
// NOTE: Due to illness, I just copied the code from the platform
// sorry for that
//
//
...
import com.example.guessthephraseparttwo.R
import com.example.guessthephraseparttwo.RecyclerViewAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvMain.adapter = RecyclerViewAdapter(this, messages)
